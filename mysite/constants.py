...
MIN_WORK_INTERVAL_MINUTES = 1
MAX_WORK_INTERVAL_MINUTES = 120  # 2 hours max
MIN_BREAK_DURATION_SECONDS = 5
MAX_BREAK_DURATION_SECONDS = 300  # 5 minutes max
MIN_LONG_BREAK_MINUTES = 1
MAX_LONG_BREAK_MINUTES = 30

# Experience and Leveling
LEVEL_UP_MULTIPLIER = 1.2  # Experience requirement growth rate
MIN_EXPERIENCE_POINTS = 0
MAX_EXPERIENCE_POINTS = 1000000
